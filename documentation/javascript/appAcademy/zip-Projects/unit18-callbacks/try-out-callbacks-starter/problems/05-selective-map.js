...
*******************************************************************************/
/* - each function performs a different task, isEven() and isPositive() are returning boolean conditions while
 the latter two function square() and flipSign() are math operations 
 - I expect the first two call backs to return a boolean and the latter two to perform the operation
 - The cb functions are only being ran once within the selectiveMap function
 */
function isEven(n) {
    return n % 2 === 0;
}
